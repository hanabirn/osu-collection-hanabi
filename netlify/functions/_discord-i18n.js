...
const S = {
    ...
    deferred_timeout: { en: 'That took too long — please try again.', zh: '處理逾時，請再試一次。', zhs: '处理超时，请再试一次。', ja: '処理に時間がかかりすぎました。もう一度お試しください。', fr: 'Ça a pris trop de temps — réessaie.', de: 'Das hat zu lange gedauert — bitte erneut versuchen.', ru: 'Слишком долго — попробуйте ещё раз.', es: 'Tardó demasiado — inténtalo de nuevo.', ko: '처리가 너무 오래 걸렸습니다. 다시 시도해 주세요.' },
    ...
    tpool_pick_round: { en: 'Tap a round below to see its maps', zh: '點下方按鈕看該輪圖池', zhs: '点下方按钮看该轮图池', ja: '下のボタンでラウンドの譜面を表示', fr: 'Touchez un round ci-dessous pour voir ses maps', de: 'Tippe unten auf eine Runde, um ihre Maps zu sehen', ru: 'Нажмите раунд ниже, чтобы увидеть его карты', es: 'Toca una ronda abajo para ver sus mapas', ko: '아래 라운드를 눌러 맵 보기' },
    tpool_list_title: { en: 'Community tournament pools ({n})', zh: '社群賽事圖池（{n}）', zhs: '社群赛事图池（{n}）', ja: 'コミュニティ大会プール（{n}）', fr: 'Mappools de tournoi communautaires ({n})', de: 'Community-Turnier-Pools ({n})', ru: 'Турнирные маппулы сообщества ({n})', es: 'Pools de torneo de la comunidad ({n})', ko: '커뮤니티 토너먼트 풀 ({n})' },
    tpool_list_title_f: { en: 'Community pools · {filt} ({n})', zh: '社群圖池 · {filt}（{n}）', zhs: '社群图池 · {filt}（{n}）', ja: 'コミュニティプール · {filt}（{n}）', fr: 'Mappools communautaires · {filt} ({n})', de: 'Community-Pools · {filt} ({n})', ru: 'Маппулы сообщества · {filt} ({n})', es: 'Pools de la comunidad · {filt} ({n})', ko: '커뮤니티 풀 · {filt} ({n})' },
    tpool_list_empty: { en: 'No community pools match that filter.', zh: '沒有符合這個篩選的社群圖池。', zhs: '没有符合这个筛选的社群图池。', ja: 'その条件に一致するコミュニティプールはありません。', fr: 'Aucun mappool communautaire ne correspond à ce filtre.', de: 'Keine Community-Pools passen zu diesem Filter.', ru: 'Нет маппулов сообщества по этому фильтру.', es: 'Ningún pool comunitario coincide con ese filtro.', ko: '해당 필터에 맞는 커뮤니티 풀이 없습니다.' },
    tpool_list_hint: { en: 'Tap a tournament, or add tournament: to search', zh: '點賽事開啟，或用 tournament: 搜尋', zhs: '点赛事打开，或用 tournament: 搜索', ja: '大会をタップ、または tournament: で検索', fr: 'Touchez un tournoi, ou utilisez tournament: pour chercher', de: 'Turnier antippen oder tournament: zum Suchen', ru: 'Нажмите турнир или используйте tournament: для поиска', es: 'Toca un torneo, o usa tournament: para buscar', ko: '토너먼트를 누르거나 tournament: 로 검색' },
    tpool_list_more: { en: '+{n} more', zh: '還有 {n} 個', zhs: '还有 {n} 个', ja: '他 {n} 件', fr: '+{n} autres', de: '+{n} weitere', ru: 'ещё {n}', es: '+{n} más', ko: '외 {n}개' },
