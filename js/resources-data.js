...
const OSU_RESOURCES = [
    ...
    { url: 'https://ameobea.me/osutrack/', name: 'osu!track', descKey: 'resource_osutrack_desc' },
    { url: 'https://osudaily.net', name: 'osu!daily', descKey: 'resource_osudaily_desc' },
    { url: 'https://osekai.net', name: 'Osekai', descKey: 'resource_osekai_desc' },
    { url: 'https://osustats.ppy.sh', name: 'osu!Stats', descKey: 'resource_osustats_desc' },
