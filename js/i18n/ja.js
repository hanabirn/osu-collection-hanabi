I18N.ja = {
    ...
    nav_dan: '段位認定',
    dan_page_title: '✦ 段位認定 ✦',
    dan_hint: '各モードの段位認定（dan course）——コミュニティ製作の実力認定マラソン譜面、1 段 1 譜面。リストは osu! の譜面検索が中心で、少数の精選をピン留め。mania は 4K／7K のみ。カードをクリックで osu! ページ、＋ でコレクションに追加。',
    dan_load_fail: '段位リストの読み込みに失敗しました', dan_empty: 'このモードの段位譜面が見つかりません', dan_load_more: 'もっと読み込む',
    dan_pinned: '精選',
    dan_add_page_btn: 'このページをコレクションに追加', dan_add_page_confirm: '「{name}」のこのページの {n} 譜面でコレクション分類を作成しますか？',
