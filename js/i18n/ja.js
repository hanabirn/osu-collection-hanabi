I18N.ja = {
    ...
    osu_profile_import_btn_title: 'osu! プロフィールから取り込む（お気に入り / よくプレイ）',
    ...
    ctools_btn_title: 'コレクション整理（osu! から生成 / ヘルスチェック）', ctools_title: '✨ コレクション整理',
    ...
    collection_db_btn_title: 'osu! ゲームのコレクションを読み込み / 書き出し', collection_db_title: '📦 osu! Collectionとして書き出す',
