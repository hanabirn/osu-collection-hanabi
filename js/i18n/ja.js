I18N.ja = {
    ...
    nav_dan: '段位認定',
    dan_page_title: '✦ 段位認定 ✦',
    dan_hint: '各モードの段位認定（dan course）——コミュニティ製作の実力認定マラソン譜面、1 段 1 譜面。各 keymode の現行プロジェクトの公式コースが中心で、検索で見つかったその他は「もっと見る」に。mania は 4K／7K のみ。カードをクリックで osu! ページ、＋ でコレクションに追加。',
    dan_load_fail: '段位リストの読み込みに失敗しました', dan_empty: 'このモードの段位譜面が見つかりません', dan_load_more: 'もっと読み込む',
    dan_pinned: '公式コース',
    dan_add_group_btn: '「{name}」をまとめてコレクションに追加', dan_add_group_confirm: '「{name}」の {n} 譜面でコレクション分類を作成しますか？',
    dan_collection_name: '段位認定 - {mode}',
    dan_more_summary: 'その他の dan course（検索結果、{n}）', dan_more_note: 'osu! の譜面検索で見つかった、タイトル／アーティストが dan course らしいその他のパックです。手動チェックはしていません。',
    dan_standard_label: '合格基準', dan_resources_label: 'リソース',
    dan_std_mania: 'マラソン全体を一度に通しでプレイし、精度 96% 以上（一部の入門段は 95%）。途中でポーズすると失格。Mirror／HD／FI／FL／HR／DT／NC のみ許可。',
    dan_std_osu: '全体を一度に通しでプレイし、精度 96% 以上（Tapping Dan Course のルール）。途中ポーズで失格。',
    dan_std_taiko: '太鼓の魂ゲージで判定。終了時に魂量がその段の合格ラインに達する必要あり（段ごとに異なる）。おおむね高精度かつ中断なし。',
    dan_std_catch: 'マラソン全体をゲージを切らさず完走。一部の段には精度の追加条件あり——フォーラムを参照。',
