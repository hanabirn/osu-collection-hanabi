I18N.ko = {
    ...
    nav_dm: '쪽지',
    chat_page_title: '채팅방',
    chat_page_hint: '다른 플레이어와 채팅하고 맵을 공유해 보세요 — osu! 비트맵 링크를 붙여넣으면 원클릭으로 컬렉션에 추가할 수 있는 카드로 바뀝니다.',
    chat_empty: '아직 아무도 말하지 않았어요. 첫 번째가 되어보세요!', chat_load_fail: '채팅방을 불러오지 못했습니다. 나중에 다시 시도해 주세요',
    chat_input_placeholder: '메시지를 입력하세요...', chat_send_btn: '전송',
    chat_emoji_btn_title: '이모지', chat_emoji_recent: '최근 사용',
    chat_edit_btn_title: '수정', chat_edited_marker: '(수정됨)',
    chat_edit_save: '저장', chat_edit_cancel: '취소', chat_edit_fail: '수정에 실패했습니다. 다시 시도하세요',
    chat_attach_btn_title: '이미지 / GIF 첨부', chat_media_remove_title: '이미지 제거',
    chat_media_too_big: '이미지가 너무 큽니다 (최대 4 MB)', chat_media_bad_type: 'PNG, JPEG, GIF, WebP 이미지만 가능',
    chat_media_upload_fail: '이미지 업로드에 실패했습니다. 다시 시도하세요', chat_media_disabled: '이미지 업로드가 현재 비활성화되어 있습니다',
    ...
    chat_translate_loading: '번역 중...', chat_translate_fail: '번역 실패, 나중에 다시 시도해 주세요', chat_translate_same_lang: '이 메시지는 이미 현재 언어로 되어 있습니다', chat_translate_unchanged: '번역 결과가 원문과 같습니다',
    ...
    chat_rate_limited: '너무 빨리 보내고 있어요, 잠시 후 다시 시도해 주세요', chat_send_fail: '전송 실패, 나중에 다시 시도해 주세요',

    dm_page_title: '쪽지', dm_page_hint: '다른 플레이어와 1:1로 대화하세요.',
    dm_new_username_placeholder: '사용자 이름을 입력해 대화를 시작하세요...', dm_start_btn: '대화 시작',
    dm_login_required: 'osu!에 로그인해야 쪽지를 사용할 수 있습니다',
    dm_empty: '아직 대화가 없어요. 사용자 이름을 입력해 첫 메시지를 보내보세요!',
    ...
    tournaments_title: '대회', tournaments_hint: '공식 포럼 「Tournaments」 게시판과 wyBin 플랫폼의 커뮤니티 대회를 함께 모아 보여줍니다. 공식 주최가 아니므로 참가 전 주최자의 규칙을 직접 확인해 주세요.', tournaments_filter_hint: '게임 모드는 제목의 키워드로 추측합니다. 인식되지 않는 제목은 "전체"에만 표시됩니다.', osu_filter_all: '전체', tournament_source_forum: '포럼', tournament_rank_label: '참가 랭크', tournament_rank_all: '전체 랭크', tournament_rank_open: '오픈 랭크', tournament_rank_worldcup: '월드컵', tournament_rank_digit: '{n}자리', tournament_rank_unknown: '미표기',
    ...
    skins_backup_btn: '클라우드에 백업', skins_backup_title: '클라우드 백업',
    ...
    osu_password: '컬렉션 비밀번호 설정\n이후 gallery 공개, 가져오기 / 내보내기에서 입력을 요구합니다',
    osu_refresh_all_title: '모든 맵의 최신 데이터 다시 가져오기 (별점, 상태)',
    tools_group_io: '컬렉션 입출력', tools_group_tools: '도구・설정',
    howto_summary: '사용 방법',
    howto_ctools: '<ol><li>먼저 osu!로 로그인 (오른쪽 위)</li><li>계정에서 카테고리 생성: 즐겨찾기 / 자주 플레이 / 베스트 기록 / 최근 / 특정 매퍼</li><li>상태 점검: 중복, 삭제됨, 비 ranked, 난이도 수 변경 맵 찾기</li><li>생성한 카테고리는 컬렉션에 병합되며, "osu! Collection으로 내보내기"로 게임에 되돌릴 수 있습니다</li></ol>',
    ...
    osu_page_title: 'osu! 비트맵 컬렉션 + 총 PP 조회', lookup_mode_single: '개인 조회', lookup_mode_compare: '둘 비교', visitor_lookup_title: 'osu! PP 조회', visitor_lookup_placeholder: 'osu! 사용자 이름 또는 ID', visitor_lookup_btn: '검색', osu_login_btn: 'osu!로 로그인', osu_logout_btn: '로그아웃', osu_login_fail: 'osu! 로그인에 실패했습니다. 다시 시도해 주세요',
    osu_profile_import_confirm: 'osu! 계정을 찾았습니다. 즐겨찾기한 비트맵과 가장 많이 플레이한 상위 50개를 컬렉션으로 가져올까요? (기존 데이터는 덮어쓰지 않습니다)',
    osu_profile_import_btn_title: 'osu! 계정에서 즐겨찾기 / 자주 플레이 가져오기\n로그인 필요; 기존 컬렉션을 덮어쓰지 않고 없는 맵만 추가',
    ...
    ctools_btn_title: '계정으로 카테고리 생성하고 상태 점검', ctools_title: '컬렉션 정리',
    ...
    osu_export: '컬렉션을 JSON 백업으로 다운로드', osu_import: 'JSON 백업에서 복원\n이전에 "내보내기"로 받은 .json 파일을 선택하면 맵과 카테고리를 가져옵니다',
    ...
    osu_share_link_btn: '컬렉션 공유 링크 복사', osu_share_link_done: '링크가 복사되었습니다! 친구에게 공유하면 열기만 해도 한 번에 가져올 수 있어요.',
    ...
    collection_card_btn: '컬렉션 미리보기 이미지(PNG) 다운로드', collection_card_title: '내 osu! 컬렉션', collection_card_done: '컬렉션 카드가 다운로드되었습니다!', collection_card_fail: '컬렉션 카드 생성 실패',
    ...
    gallery_scores_truncated: '(처음 {n}개 / 전체 {all})', gallery_embed_btn: '임베드 코드 복사', gallery_embed_copied: '임베드 코드를 복사했습니다!',
    ...
    catalog_mode_all: '전체 모드',
    catalog_status_all: '모든 상태', catalog_status_ranked: 'Ranked', catalog_status_loved: 'Loved', catalog_nsfw_toggle: '18+ 포함',
    catalog_coverage: '{n}개 비트맵셋 수록 · 마지막 업데이트 {t} · 현재 필터 {m}개 (데이터베이스는 계속 확장 중이며 모든 ranked 맵을 포함하지 않음)',
    ...
    nav_games: '미니게임',
    games_back: '뒤로',
    games_daily_prompt: '{n}번 남음',
    games_quiz_title: '장르 스피드',
    games_quiz_blurb: '맵이 계속 나오면 장르를 누르세요. 60초 동안 최대한 많이.',
    games_quiz_prompt: '이 맵의 장르는?',
    games_quiz_time: '{n}초',
    games_quiz_score: '정답 {n}',
    games_quiz_over: '시간 종료! 정답 {n}개.',
    games_quiz_best: '최고 {n}',
    games_quiz_again: '다시 하기',
    games_quiz_correct_was: '정답: {name}',
    games_quiz_no_data: '아직 맵 데이터가 부족합니다. 나중에 다시 시도하세요.',
    ...
    games_daily_blurb: '하루 한 개의 ranked 세트 — 흐릿한 커버로 곡을 맞히고, 틀릴 때마다 힌트가 하나씩.',
    games_hilo_title: 'Higher or Lower',
    games_hilo_blurb: 'Farm 맵 두 개 — 어느 쪽 수치가 더 높은지 맞히기. 무한, 연승제.',
    games_daily_not_ready: '오늘의 문제가 아직 준비되지 않았습니다. 잠시 후 다시 시도하세요.',
    games_daily_input_ph: '곡 또는 맵 제목…',
    games_daily_guess_btn: '맞히기',
    games_daily_win: '{n}번 만에 정답!',
    games_daily_lose: '기회를 모두 사용했습니다.',
    games_daily_share: '결과 복사',
    games_daily_copied: '결과를 클립보드에 복사했습니다',
    games_daily_streak: '{n}일 연속',
    games_daily_clip: '{s}초 재생',
    games_hint_genre: '장르',
    games_hint_lang: '언어',
    games_hint_year: 'Ranked 연도',
    games_hint_sr: '난이도(★)',
    games_hint_mapper: 'Mapper',
    games_hilo_ask: '{stat}이(가) 더 높을까요?',
    games_hilo_higher: '더 높음',
    games_hilo_lower: '더 낮음',
    games_hilo_next: '다음',
    games_hilo_again: '다시 하기',
    games_hilo_over: '연승이 {n}에서 끝났습니다.',
    games_hilo_best: '최고 {n}',
    games_hilo_streak: '연승 {n}',
    games_hilo_no_data: '아직 맵 데이터가 부족합니다. 나중에 다시 시도하세요.',
    games_stat_sr: '난이도',
    games_stat_bpm: 'BPM',
    games_stat_len: '길이',
    games_stat_pp: 'farm PP',
    games_stat_plays: '플레이 횟수',
    games_save_btn: '컬렉션에 추가',
    games_save_confirm: '이 비트맵셋을 컬렉션에 추가할까요?',
    games_board_title: '순위표',
    games_board_empty: '아직 기록이 없어요 — 첫 주자가 되어보세요!',
    games_board_login: '로그인하면 점수가 순위표에 올라갑니다',
    games_save_category: '미니게임에서',
    games_save_done: '컬렉션에 {n}개 세트를 추가했습니다',
    mappools_page_title: '월드컵 맵풀',
    ...
    cmpool_import_none: 'wyBin에 이 대회의 맵풀 데이터가 없습니다 — 직접 입력하세요',
    cmpool_search_ph: '등록된 대회 맵풀 검색…',
    cmpool_new_btn: '＋ 새로 만들기 / 대회 참여',
    cmpool_create_name_ph: '대회 이름 (목록에서 선택하거나 직접 입력)',
    cmpool_create_go: '만들기',
    cmpool_create_cancel: '취소',
    ...
    cmpool_custom_round_ph: '사용자 지정 라운드…',
    cmpool_add_bracket: '모드 추가:',
    cmpool_custom_bracket_ph: '사용자 지정 모드…',
    cmpool_add_map_ph: 'beatmap 난이도 링크 또는 ID 붙여넣기',
    cmpool_bulk_hint: '여러 비트맵 링크나 ID를 한 번에 붙여넣기',
    cmpool_bulk_ph: '한 줄에 하나씩 비트맵 난이도 링크나 ID를 붙여넣으세요. "NM1:" 같은 접두어도 괜찮습니다.',
    cmpool_bulk_add: '모두 추가',
    cmpool_bulk_working: '처리 중…',
    cmpool_bulk_added: '{n}개 추가',
    cmpool_bulk_dupes: '{n}개는 이미 있음',
    cmpool_bulk_unresolved: '{n}개는 인식 불가',
    cmpool_bulk_overflow: '{n}개는 상한 초과',
    cmpool_remove_map: '이 맵 제거',
    cmpool_remove_bracket: '이 모드 칸 제거',
    cmpool_remove_round: '이 라운드 제거',
    mappools_hint: '역대 osu! 월드컵(OWC／TWC／MWC 4K・7K／CWC)의 공식 맵풀. 데이터는 osu! wiki에서 가져옵니다. 대회를 선택하면 대회 전체 또는 한 라운드를 한 번에 컬렉션 분류로 만들 수 있습니다.',
    mappools_add_event_btn: '➕ 대회 전체 추가',
    mappools_round_add_btn: '➕ 이 라운드',
    mappools_add_confirm: '"{name}"의 비트맵 세트 {n}개를 컬렉션에 추가하고 같은 이름의 분류를 만들까요?',
    mappools_add_done: '"{name}"을(를) 컬렉션에 추가: 새 세트 {n}개, 분류 {cat}개',
    mappools_mappack: '공식 맵팩',
    mappools_showcase: '쇼케이스',
    ...
    resource_osustats_desc: '리더보드 순위 집계 — top-50 / top-100을 몇 개 보유했는지',
    ...
    grade_history_tab: '등급 기록', grade_history_need_lookup: '먼저 "PP 조회" 페이지에서 플레이어를 조회해 주세요',
    grade_history_loading: '등급 기록 불러오는 중...', grade_history_load_fail: '등급 기록을 불러오지 못했습니다. 나중에 다시 시도해 주세요',
    grade_history_note: '데이터는 서드파티 추적 서비스 osu!Track에서 가져오며, 실제로 기록된 성적만 표시할 수 있어 완전성을 보장하지 않습니다 (osu! 공식 API에는 전체 성적 기록 기능이 없습니다).',
    grade_history_empty: 'osu!Track에 이 플레이어의 이 모드 기록이 없습니다',
    ...
    howto_manual_body: `
        ...
        <div class="howto-group" id="howto-core">
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>도구·설정 (버튼 7개)</b><span>모든 맵 데이터 새로고침 → 📊 통계 대시보드(업적 배지 8개 포함) → ✨ 컬렉션 정리 마법사(아래 설명 참고) → 플레이함 표시/즐겨찾기·자주 플레이 원클릭 가져오기(로그인 필요) → 📁 osu!.db를 업로드해 이미 가진 맵을 확인(osu! stable 전용) → 🔒 비밀번호 설정, 이후 편집/발행 작업에 필요.</span></div>
                <div class="howto-feat"><b>검색 / 필터 / 정렬</b><span>곡명이나 아티스트로 검색; 언어, 장르, 출처, 아티스트로 필터링; 별점으로 정렬 가능.</span></div>
                <div class="howto-feat"><b>이 목록 전체 다운로드</b><span>현재 탭/검색/필터 결과(모든 페이지 포함)의 맵을 .osz로 하나씩 순서대로 다운로드합니다. 로그인 불필요한 미러 경유라 앱 설치도 필요 없습니다. 같은 버튼으로 다운로드 중 일시정지/재개할 수 있고, 진행 중인 파일은 중단되지 않습니다. 완료되면 파일을 전부 선택해서 osu!에 한꺼번에 드래그하면 가져올 수 있습니다.</span></div>
                <div class="howto-feat"><b>아직 없는 비트맵 다운로드</b><span>osu!.db를 선택하면 나타나며, 현재 목록 중 osu!에 아직 없는 비트맵 수가 버튼에 표시됩니다. 그 비트맵만 다운로드하고 이미 있는 것은 건너뛰며, 일시정지/재개도 똑같이 됩니다. osu!에 가져온 뒤 osu!.db를 다시 선택하면 숫자가 갱신됩니다.</span></div>
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>컬렉션 상세</b><span>카드를 클릭해 열면 모드/분류 탭 전환, 원클릭 가져오기, 공유 링크 복사가 가능합니다. 로그인하면 "내 성적 겹쳐 보기"(맵마다 자신의 등급 + 등급 통계 표시)와 포럼/블로그에 붙일 수 있는 iframe용 "임베드 코드 복사"도 쓸 수 있습니다. 아래에 댓글란이 있습니다——로그인하면 누구나 댓글을 달 수 있고, 삭제는 댓글 작성자 본인이나 해당 컬렉션 발행자가 할 수 있습니다.</span></div>
            </div>
