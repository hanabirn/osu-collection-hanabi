I18N.ko = {
    ...
    tournaments_title: '✦ 대회 ✦', tournaments_hint: '공식 포럼 「Tournaments」 게시판의 커뮤니티 대회 게시물입니다. 공식 주최가 아니므로 참가 전 주최자의 규칙을 직접 확인해 주세요.', tournaments_filter_hint: '게임 모드는 제목의 키워드로 추측합니다. 인식되지 않는 제목은 "전체"에만 표시됩니다.', osu_filter_all: '전체',
