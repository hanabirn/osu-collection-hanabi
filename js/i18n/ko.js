I18N.ko = {
    ...
    dan_hint: "각 모드의 단위 인정(dan course) — 커뮤니티가 만든 실력 인증 마라톤 맵, 단마다 한 곡. 목록은 osu! 비트맵 검색을 기반으로 하고 소수의 엄선 항목을 상단에 고정합니다. mania는 4K/7K만. 카드를 클릭하면 osu! 페이지, +로 컬렉션에 추가.",
    dan_load_fail: '단위 목록을 불러오지 못했습니다', dan_empty: '이 모드의 단위 맵을 찾을 수 없습니다', dan_load_more: '더 보기',
    dan_pinned: '엄선',
    dan_add_page_btn: '이 페이지를 컬렉션에 추가', dan_add_page_confirm: '"{name}"의 이 페이지 {n}개 맵으로 컬렉션 분류를 만들까요?',
