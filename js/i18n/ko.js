I18N.ko = {
    ...
    nav_dan: '단위 인정',
    dan_page_title: '✦ 단위 인정 ✦',
    dan_hint: '각 모드의 단위 인정(dan course) — 커뮤니티가 만든 실력 인증 마라톤 맵, 단마다 한 곡. 각 keymode의 현행 프로젝트 공식 코스가 중심이고, 검색으로 찾은 나머지는 "더 보기"에 있습니다. mania는 4K/7K만. 카드를 클릭하면 osu! 페이지, +로 컬렉션에 추가.',
    dan_load_fail: '단위 목록을 불러오지 못했습니다', dan_empty: '이 모드의 단위 맵을 찾을 수 없습니다', dan_load_more: '더 보기',
    dan_pinned: '공식 코스',
    dan_add_group_btn: '"{name}" 전체를 컬렉션에 추가', dan_add_group_confirm: '"{name}"의 {n}개 맵으로 컬렉션 분류를 만들까요?',
    dan_collection_name: '단위 인정 - {mode}',
    dan_more_summary: '기타 dan course (검색 결과, {n})', dan_more_note: 'osu! 비트맵 검색에서 찾은, 제목/아티스트가 dan course 형식인 기타 팩입니다. 수동 확인은 하지 않았습니다.',
    dan_standard_label: '통과 기준', dan_resources_label: '자료',
    dan_std_mania: '마라톤 전체를 한 번에 이어서 플레이, 정확도 96% 이상(일부 입문 단은 95%). 도중 일시정지 시 실패, Mirror/HD/FI/FL/HR/DT/NC만 허용.',
    dan_std_osu: '전체를 한 번에 이어서 플레이, 정확도 96% 이상(Tapping Dan Course 규칙). 도중 일시정지 시 실패.',
    dan_std_taiko: '타이코의 소울 게이지로 판정 — 종료 시 게이지가 해당 단의 통과선에 도달해야 함(단마다 다름). 대체로 높은 정확도와 중단 없음.',
    dan_std_catch: '게이지가 바닥나지 않게 마라톤 전체를 완주. 일부 단은 추가 정확도 조건 있음 — 포럼 참고.',
