I18N.ko = {
    ...
    replay_submitting: '업로드 중...', replay_rendering: '제출됨, 생성을 시작합니다...', replay_submit_fail: '제출 실패: {n}', replay_render_fail: '생성 실패 (오류 코드 {n})', replay_render_fail_short: '생성 실패', replay_render_done: '영상이 완성되었습니다!', replay_progress: '생성 중: {n}', replay_skin_none: '일치하는 스킨을 찾을 수 없습니다', replay_history_empty: '아직 생성한 영상이 없습니다', replay_preview_show: '미리보기', replay_preview_hide: '미리보기 닫기', replay_watch: '영상 보기', replay_history_pending: '생성 중...',
