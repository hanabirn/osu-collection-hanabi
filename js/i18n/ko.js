I18N.ko = {
    ...
    nav_collection: '컬렉션', nav_lookup: 'PP 조회', nav_skins: '스킨', nav_updates: '업데이트 소식', nav_mapper_tracking: '매퍼 추적', nav_tournaments: '대회', nav_resources: '리소스', nav_feedback: '제안&개선', nav_menu_open: '메뉴 열기', nav_more: '더 보기', nav_menu_title: '메뉴', nav_group_core: '핵심 기능', nav_group_tools: '도구', nav_group_resources: '리소스',
    ...
    local_scan_btn_title: '로컬 osu! Songs 폴더를 선택해 이미 가진 맵을 확인\nChrome/Edge에서만 지원, osu! stable만 인식',
    ...
    ctools_btn_title: '기록으로 카테고리·연습 컬렉션 생성하고 상태 점검', ctools_title: '컬렉션 정리',
    ...
    catalog_mode_all: '전체 모드', catalog_nsfw_toggle: '18+ 포함',
    ...
    howto_manual_body: `
        ...
        <div class="howto-group" id="howto-core">
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>도구·설정 (버튼 7개)</b><span>모든 맵 데이터 새로고침 → 📊 통계 대시보드(업적 배지 8개 포함) → ✨ 컬렉션 정리 마법사(아래 설명 참고) → 플레이함 표시/즐겨찾기·자주 플레이 원클릭 가져오기(로그인 필요) → 📁 로컬 osu! Songs 폴더를 선택해 이미 가진 맵을 확인(Chrome/Edge에서만 지원, osu! stable만 인식) → 🔒 비밀번호 설정, 이후 편집/발행 작업에 필요.</span></div>
