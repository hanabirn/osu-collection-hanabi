I18N.zh = {
    ...
    replay_submitting: '上傳中...', replay_rendering: '已送出，開始生成影片...', replay_submit_fail: '送出失敗：{n}', replay_render_fail: '生成失敗（錯誤代碼 {n}）', replay_render_fail_short: '生成失敗', replay_render_done: '影片已完成！', replay_progress: '生成中：{n}', replay_skin_none: '找不到符合的皮膚', replay_history_empty: '還沒有生成過影片', replay_preview_show: '預覽', replay_preview_hide: '收合預覽', replay_watch: '觀看影片', replay_history_pending: '生成中...', replay_preview_expired: '此影片已過期（o!rdr 只會保留影片一段時間），請重新上傳 replay 產生新的影片',
