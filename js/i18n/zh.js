I18N.zh = {
    ...
    osu_profile_import_btn_title: '從 osu! 個人檔案匯入（最愛 / 常玩）',
    ...
    ctools_btn_title: '收藏整理（從 osu! 帳號生成 / 健康檢查）', ctools_title: '✨ 收藏整理',
    ...
    practice_gen_lowacc: '低準度重練', practice_gen_taste: '沒打過的相似圖',
    practice_cat_push: '🎯 突破分', practice_cat_goal: '🎯 目標 {target}pp',
    practice_cat_lowacc: '🎯 低準度重練', practice_cat_taste: '🎯 相似圖',
    ...
    collection_db_btn_title: '匯入 / 匯出 osu! 遊戲收藏', collection_db_title: '📦 匯出成 osu! Collection',
