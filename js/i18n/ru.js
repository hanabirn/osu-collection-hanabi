I18N.ru = {
    ...
    nav_dan: 'Дан-курсы',
    dan_page_title: '✦ Дан-курсы ✦',
    dan_hint: 'Дан-курсы (проверка навыка) для каждого режима - марафоны-бенчмарки от сообщества, по одной карте на дан. Во главе - актуальный проект каждого keymode; прочие дан-курсы из поиска собраны под "Ещё". Mania только 4K/7K. Нажмите на карточку, чтобы открыть на osu!, + чтобы добавить в коллекцию.',
    dan_load_fail: 'Не удалось загрузить дан-курсы', dan_empty: 'Дан-курсы для этого режима не найдены', dan_load_more: 'Загрузить ещё',
    dan_pinned: 'Отобрано',
    dan_add_group_btn: 'Добавить всю группу "{name}" в коллекцию', dan_add_group_confirm: 'Создать категорию коллекции из {n} наборов в "{name}"?',
    dan_collection_name: 'Дан-курсы - {mode}',
    dan_more_summary: 'Другие дан-курсы (из поиска, {n})', dan_more_note: 'Другие паки из поиска карт osu!, у которых название/исполнитель похожи на дан-курс - без ручной проверки.',
    dan_standard_label: 'Условие сдачи', dan_resources_label: 'Ресурсы',
    dan_std_mania: 'Пройти весь марафон за один заход с точностью 96%+ (95% на некоторых вводных данах); пауза = провал, разрешены только Mirror/HD/FI/FL/HR/DT/NC.',
    dan_std_osu: 'Пройти весь заход за один раз с точностью 96%+ (правило Tapping Dan Course); пауза = провал.',
    dan_std_taiko: 'Оценивается по шкале души в тайко - к концу она должна достичь линии сдачи этого дана (зависит от дана). В целом высокая точность без перерывов.',
    dan_std_catch: 'Пройти весь марафон, не обнулив шкалу; у некоторых данов есть дополнительный порог точности - см. тему на форуме.',
    ...
    howto_manual_body: `
        ...
        <div class="howto-group" id="howto-core">
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>Вкладки категорий</b><span>Помимо фиксированных вкладок Избранное/Standard/Taiko/Catch/Mania, иконка шестерёнки открывает «Управление категориями» для добавления своих.</span></div>
