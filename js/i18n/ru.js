I18N.ru = {
    ...
    dan_hint: 'Дан-курсы (проверка навыка) для каждого режима — марафоны-бенчмарки от сообщества, по одной карте на дан. Список формируется из поиска карт osu! плюс несколько закреплённых вручную; mania только 4K/7K. Нажмите на карточку, чтобы открыть на osu!, или + чтобы добавить в коллекцию.',
    dan_load_fail: 'Не удалось загрузить дан-курсы', dan_empty: 'Дан-курсы для этого режима не найдены', dan_load_more: 'Загрузить ещё',
    dan_pinned: 'Отобрано',
    dan_add_page_btn: 'Добавить эту страницу в коллекцию', dan_add_page_confirm: 'Создать категорию коллекции из {n} карт на этой странице «{name}»?',
