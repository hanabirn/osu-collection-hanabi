I18N.ru = {
    title: 'osu!Hanabi — набор инструментов для osu!-коллекций', site_title: 'osu!Hanabi', site_tagline: '✦ Твой набор инструментов для osu!-коллекций и тренировок ✦',
    site_like_label: 'Нравится', site_like_title: 'Понравился сайт? Поставьте лайк!', site_share_label: 'Поделиться', site_share_title: 'Поделиться сайтом с друзьями', site_share_copied: 'Ссылка на сайт скопирована!', site_share_text: 'osu!Hanabi — приведи в порядок свои osu!-коллекции, собирай тренировочные пулы по результатам, смотри PP',
