I18N.fr = {
    ...
    dan_hint: "Cours dan (certification de compétence) pour chaque mode — des marathons de référence créés par la communauté, une map par dan. La liste s'appuie sur la recherche de beatmaps d'osu! plus quelques épingles choisies à la main ; mania en 4K/7K uniquement. Clique sur une carte pour l'ouvrir sur osu!, ou + pour l'ajouter à ta collection.",
    dan_load_fail: 'Échec du chargement des cours dan', dan_empty: 'Aucun cours dan trouvé pour ce mode', dan_load_more: 'Charger plus',
    dan_pinned: 'Sélection',
    dan_add_page_btn: 'Ajouter cette page à la collection', dan_add_page_confirm: 'Créer une catégorie de collection à partir des {n} maps de cette page de « {name} » ?',
