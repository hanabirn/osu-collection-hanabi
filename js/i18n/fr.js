I18N.fr = {
    ...
    nav_dan: 'Cours dan',
    dan_page_title: '✦ Cours dan ✦',
    dan_hint: "Cours dan (certification de competence) pour chaque mode - marathons de reference crees par la communaute, une map par dan. Menes par le projet actuel de chaque keymode ; les autres cours dan trouves par recherche sont sous \" Plus \". Mania en 4K/7K uniquement. Clique sur une carte pour l'ouvrir sur osu!, + pour l'ajouter a ta collection.",
    dan_load_fail: 'Echec du chargement des cours dan', dan_empty: 'Aucun cours dan trouve pour ce mode', dan_load_more: 'Charger plus',
    dan_pinned: 'Selection',
    dan_add_group_btn: 'Ajouter tout "{name}" a la collection', dan_add_group_confirm: 'Creer une categorie de collection a partir des {n} sets de "{name}" ?',
    dan_collection_name: 'Cours dan - {mode}',
    dan_more_summary: 'Autres cours dan (via la recherche, {n})', dan_more_note: "Autres packs de la recherche de beatmaps d'osu! dont le titre/artiste ressemble a un cours dan - non verifies a la main.",
    dan_standard_label: 'Critere de reussite', dan_resources_label: 'Ressources',
    dan_std_mania: 'Terminer tout le marathon en une seule fois avec 96%+ de precision (95% sur certains dans d introduction) ; une pause fait echouer, seuls Mirror/HD/FI/FL/HR/DT/NC autorises.',
    dan_std_osu: 'Terminer toute la serie en une seule fois avec 96%+ de precision (regle Tapping Dan Course) ; une pause fait echouer.',
    dan_std_taiko: "Juge par la jauge d'ame du taiko - elle doit atteindre la ligne de reussite du dan a la fin (variable selon le dan). En gros une haute precision sans interruption.",
    dan_std_catch: 'Terminer tout le marathon sans vider la jauge ; certains dans ont un seuil de precision supplementaire - voir le fil du forum.',
    ...
    farm_only_toggle_title: 'osu!／taiko : part de DT dans le Top 50 ≥ 70 % ; catch／mania : part de 100 % de précision dans le Top 50 ≥ 70 % (nécessite ≥ 500 parties)',
