I18N.fr = {
    ...
    local_scan_btn_title: 'Choisir ton dossier osu! Songs local pour voir quelles maps tu as déjà\nChrome/Edge uniquement, détecte seulement osu! stable',
    ...
    howto_manual_body: `
        ...
        <div class="howto-group" id="howto-core">
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>Outils et réglages (7 boutons)</b><span>Actualiser toutes les données des cartes → 📊 Tableau de bord statistiques (avec 8 badges de succès) → ✨ Assistant de collection (voir ci-dessous) → Marquer comme joué / import en un clic des favoris et plus joués (connexion requise) → 📁 Choisir ton dossier osu! Songs local pour voir quelles maps tu as déjà (Chrome/Edge uniquement, détecte seulement osu! stable) → 🔒 Définir un mot de passe, requis pour les futures modifications/publications.</span></div>
