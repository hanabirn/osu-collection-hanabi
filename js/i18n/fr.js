I18N.fr = {
    ...
    replay_submitting: 'Téléversement...', replay_rendering: 'Envoyé, rendu en cours...', replay_submit_fail: "Échec de l'envoi : {n}", replay_render_fail: 'Échec du rendu (erreur {n})', replay_render_fail_short: 'Échec du rendu', replay_render_done: 'Vidéo prête !', replay_progress: 'Rendu en cours : {n}', replay_skin_none: 'Aucun skin correspondant', replay_history_empty: 'Aucune vidéo générée pour le moment', replay_preview_show: 'Aperçu', replay_preview_hide: 'Masquer l\'aperçu', replay_watch: 'Voir la vidéo', replay_history_pending: 'Rendu en cours...', replay_preview_expired: 'Cette vidéo a expiré (o!rdr ne conserve les vidéos que temporairement) — réimportez le replay pour en générer une nouvelle.',
