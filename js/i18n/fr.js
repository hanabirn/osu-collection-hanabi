I18N.fr = {
    ...
    site_like_label: 'J’aime', site_like_title: 'Ce site vous plaît ? Mettez un like !', site_changelog_label: 'Nouveautés', site_changelog_title: 'Ce qui a changé dans ce déploiement', site_share_label: 'Partager', site_share_title: 'Partager ce site avec des amis', site_share_copied: 'Lien du site copié !', site_share_text: 'Constitue ta propre collection de musiques osu !',
    ...
    nav_chat: 'Chat',
    nav_dm: 'Messages privés',
    chat_page_title: 'Chat',
    chat_page_hint: "Discutez avec d'autres joueurs, cherchez des coéquipiers, partagez des cartes — collez un lien de beatmap osu! et il se transforme en carte avec un bouton pour l'ajouter à votre collection en un clic.",
    chat_empty: "Personne n'a encore parlé — soyez le premier !", chat_load_fail: 'Échec du chargement du chat, réessayez plus tard',
    chat_input_placeholder: 'Écrire un message...', chat_send_btn: 'Envoyer',
    chat_emoji_btn_title: 'Émoji', chat_emoji_recent: 'Récents',
    chat_edit_btn_title: 'Modifier', chat_edited_marker: '(modifié)',
    chat_edit_save: 'Enregistrer', chat_edit_cancel: 'Annuler', chat_edit_fail: 'Échec de la modification, réessayez',
    chat_attach_btn_title: 'Joindre une image / un GIF', chat_media_remove_title: 'Retirer l\'image',
    chat_media_too_big: 'Image trop volumineuse (max 4 Mo)', chat_media_bad_type: 'Images PNG, JPEG, GIF ou WebP uniquement',
    chat_media_upload_fail: 'Échec de l\'envoi de l\'image, réessayez', chat_media_disabled: 'L\'envoi d\'images est actuellement désactivé',
    chat_login_required: 'Connectez-vous avec osu! pour discuter',
    ...
    chat_rate_limited: 'Vous envoyez trop vite, ralentissez', chat_send_fail: "Échec de l'envoi, réessayez plus tard",

    dm_page_title: 'Messages privés', dm_page_hint: "Discutez en tête-à-tête avec d'autres joueurs.",
    dm_new_username_placeholder: 'Entrez un nom d’utilisateur pour démarrer une conversation...', dm_start_btn: 'Démarrer la conversation',
    dm_login_required: 'Connectez-vous avec osu! pour utiliser les messages privés',
    dm_empty: "Aucune conversation pour l'instant — entrez un nom d'utilisateur pour envoyer votre premier message !",
    dm_thread_empty: 'Aucun message pour le moment — dites bonjour !',
    dm_back_btn: 'Retour',
    ...
    tournaments_title: 'Tournois', tournaments_hint: "Tournois communautaires du sous-forum officiel « Tournaments » et de la plateforme wyBin — ce ne sont pas des événements officiels, vérifiez les règles de l'organisateur avant de vous inscrire.", tournaments_filter_hint: "Le mode de jeu est deviné à partir du titre — les fils non reconnus n'apparaissent que dans « Tous ».", osu_filter_all: 'Tous', tournament_source_forum: 'Forum', tournament_rank_label: 'Rang admis', tournament_rank_all: 'Tous les rangs', tournament_rank_open: 'Rang ouvert', tournament_rank_worldcup: 'Coupe du monde', tournament_rank_digit: '{n} chiffres', tournament_rank_unknown: 'Non précisé',
    ...
    skins_backup_btn: 'Sauvegarder dans le cloud', skins_backup_title: 'Sauvegarde cloud',
    ...
    local_db_btn_title: "Envoie ton osu!.db pour voir quelles maps tu as déjà\nosu! stable uniquement, généralement dans %localappdata%\\osu!\\osu!.db",
    local_db_copy_path_title: "Copier le chemin de osu!.db — colle-le dans le champ nom de fichier du sélecteur pour y aller directement\n%localappdata%\\osu!\\osu!.db",
    local_db_path_copied: "Chemin copié — colle-le dans le champ nom de fichier",
    local_db_fail: "Impossible de lire ce fichier — vérifie que c'est bien l'osu!.db d'osu! stable",
    ...
    hero_stat_farm: '{n}+ maps indexées',
    ...
    osu_category_delete_confirm: "Supprimer cette catégorie ? (Les beatmaps restent dans votre collection — seule l'étiquette est retirée.)", osu_deleted: '« {n} » retiré', osu_undo: 'Annuler',
    ...
    osu_fav_btn_title: 'Ajouter aux favoris', osu_unfav_btn_title: 'Retirer des favoris', osu_delete_btn_title: 'Retirer',
    ...
    osu_page_title: 'Collection de beatmaps osu! + PP total', lookup_mode_single: 'Recherche perso', lookup_mode_compare: 'Comparer deux', visitor_lookup_title: 'Vérifier votre osu! PP', visitor_lookup_placeholder: "Nom d'utilisateur ou ID", visitor_lookup_btn: 'Rechercher', osu_login_btn: 'Connexion osu!', osu_logout_btn: 'Déconnexion', osu_login_fail: 'Échec de la connexion osu!, veuillez réessayer',
    ...
    ctools_btn_title: 'Générer des catégories depuis ton compte, plus un bilan', ctools_title: 'Outils de collection',
    ...
    mplist_mp_hint: 'Copier cette map en ligne !mp map pour un lobby multi', mplist_mp_copied: 'Copié — colle-le dans ton lobby',
    mini_player_playpause: 'Lecture/Pause', mini_player_loop: 'Boucle', mini_player_close: 'Fermer le lecteur',
    ...
    batch_dl_hint: 'En téléchargeant plusieurs fichiers, le navigateur affiche souvent « Autoriser ce site à télécharger plusieurs fichiers ? » — cliquez sur Autoriser, sinon tout fichier après le premier sera bloqué.', batch_dl_missing_btn: 'Télécharger les {n} sets que tu n’as pas', batch_dl_missing_none: 'Ton osu! a déjà tous les sets de cette liste', batch_dl_missing_confirm: 'Télécharger les {n} sets que ton osu! n’a pas encore ? ({skipped} déjà dans ton osu!.db sont ignorés.) Ils se téléchargent un par un, garde cet onglet ouvert', batch_dl_missing_done: 'Terminé ! {done} fichiers téléchargés. Double-clique chaque .osz ou glisse-le dans osu! pour l’importer, puis choisis à nouveau ton osu!.db pour mettre à jour les marques',
    ...
    gallery_scores_btn: 'Afficher mes scores', gallery_scores_checking: 'Vérification {done}/{total}', gallery_scores_summary: 'Tu as {have}/{total}',
    gallery_scores_truncated: '(les {n} premiers sur {all})', gallery_embed_btn: "Copier le code d'intégration", gallery_embed_copied: "Code d'intégration copié !",
    gallery_comments_title: 'Commentaires', gallery_comments_loading: 'Chargement des commentaires...', gallery_comments_load_fail: 'Échec du chargement des commentaires',
    gallery_comments_empty: 'Aucun commentaire pour l\'instant — sois le premier !', gallery_comments_placeholder: 'Écris un commentaire...',
    gallery_comments_send: 'Envoyer', gallery_comments_send_fail: 'Échec de l\'envoi du commentaire, réessaie plus tard',
    ...
    farm_only_toggle_title: 'Classement farm selon la part de clears faciles/pp dans le Top 50 — DT pour osu!/taiko, DT et HR pour catch, DT et full combos sans SS pour mania ; le seuil s\'assouplit quand la difficulté en étoiles augmente (nécessite ≥ 500 parties)',
    ...
    catalog_mode_all: 'Tous les modes',
    catalog_status_all: 'Tous les statuts', catalog_status_ranked: 'Ranked', catalog_status_loved: 'Loved', catalog_nsfw_toggle: 'Inclure 18+',
    catalog_coverage: '{n} beatmapsets indexés · mis à jour {t} · {m} correspondent au filtre actuel (base encore en croissance, pas encore toutes les maps ranked)',
    catalog_coverage_pending: 'La base de données est en préparation — revenez bientôt',
    catalog_empty: 'Aucun beatmapset ne correspond — essayez un autre filtre',
    catalog_load_fail: 'Échec du chargement du catalogue, réessayez plus tard',
    catalog_combo_no_match: 'Aucun résultat correspondant', catalog_combo_more_hint: '{n} résultats de plus — affinez votre recherche',
    catalog_create_collection_btn: '➕ Créer une collection depuis ce critère',
    catalog_star_filter_label: 'Filtre de difficulté', catalog_smart_toggle: 'En faire une catégorie dynamique', smart_cat_badge: 'Dynamique', smart_cat_last_sync: 'Dernière synchro {d}', smart_cat_refresh_btn: 'Récupérer les maps nouvellement classées', smart_cat_detach: 'Rendre statique', smart_cat_detach_confirm: 'Arrêter de synchroniser cette catégorie ? (les maps collectées restent)', smart_cat_no_new: 'Aucune nouvelle map correspondante', smart_cat_synced: '{n} nouvelles maps ajoutées',
    ...
    nav_games: 'Mini-jeux',
    games_back: 'Retour',
    games_daily_prompt: '{n} essais restants',
    games_quiz_title: 'Genre express',
    games_quiz_blurb: 'Une map apparaît, touche son genre. 60 secondes, un max de bonnes réponses.',
    games_quiz_prompt: 'Quel est ce genre ?',
    games_quiz_time: '{n}s',
    games_quiz_score: '{n} bonnes',
    games_quiz_over: 'Temps écoulé ! {n} bonnes réponses.',
    games_quiz_best: 'Record {n}',
    games_quiz_again: 'Rejouer',
    games_quiz_correct_was: "C'était {name}",
    games_quiz_no_data: 'Pas encore assez de données de maps, réessaie plus tard.',
    ...
    games_daily_blurb: 'Un set ranked par jour — devine-le à partir d’une pochette floue, avec un indice par erreur.',
    games_hilo_title: 'Higher or Lower',
    games_hilo_blurb: 'Deux maps Farm — choisis celle qui a la valeur la plus élevée. Sans fin, par séries.',
    games_daily_not_ready: 'L’énigme du jour n’est pas encore prête, réessaie dans une minute.',
    games_daily_input_ph: 'Titre de la musique ou de la map…',
    games_daily_guess_btn: 'Deviner',
    games_daily_win: 'Trouvé en {n} !',
    games_daily_lose: 'Plus d’essais.',
    games_daily_share: 'Copier le résultat',
    games_daily_copied: 'Résultat copié dans le presse-papiers',
    games_daily_streak: 'série de {n} jours',
    games_daily_clip: 'Écouter {s}s',
    games_hint_genre: 'Genre',
    games_hint_lang: 'Langue',
    games_hint_year: 'Ranked',
    games_hint_sr: 'Difficulté (★)',
    games_hint_mapper: 'Mapper',
    games_hilo_ask: '{stat} plus élevé ?',
    games_hilo_higher: 'Plus élevé',
    games_hilo_lower: 'Plus bas',
    games_hilo_next: 'Suivant',
    games_hilo_again: 'Rejouer',
    games_hilo_over: 'Série terminée à {n}.',
    games_hilo_best: 'Record {n}',
    games_hilo_streak: 'Série {n}',
    games_hilo_no_data: 'Pas encore assez de données de maps, réessaie plus tard.',
    games_stat_sr: 'difficulté',
    games_stat_bpm: 'BPM',
    games_stat_len: 'durée',
    games_stat_pp: 'PP de farm',
    games_stat_plays: 'nombre de parties',
    games_save_btn: 'Ajouter à la collection',
    games_save_confirm: 'Ajouter ce beatmapset à ta collection ?',
    games_board_title: 'Classement',
    games_board_empty: 'Aucun score pour l’instant — sois le premier !',
    games_board_login: 'Connecte-toi pour apparaître au classement',
    games_save_category: 'Des mini-jeux',
    games_save_done: '{n} set(s) ajouté(s) à ta collection',
    mappools_page_title: 'Mappools de la World Cup',
    cmpool_page_title: 'Mappools communautaires',
    cmpool_hint: 'Mappools de tournois remplies par la communauté — choisis un tournoi joué, ajoute des rounds et des brackets de mod, mets des ids de beatmap et le site récupère les infos. Connecte-toi pour éditer.',
    cmpool_pick_from_list: 'Choisis un tournoi dans la liste…',
    cmpool_source_label: 'Source', cmpool_mode_label: 'Mode', cmpool_mode_all: 'Tous modes',
    cmpool_source_wybin: 'wyBin', cmpool_source_forum: 'Forum', cmpool_source_custom: 'Perso',
    cmpool_importing: 'Import de la pool depuis wyBin…',
    cmpool_imported_n: '{n} maps importées depuis wyBin',
    cmpool_import_none: 'wyBin n\'a pas de données de pool pour ce tournoi — saisis-la à la main',
    cmpool_search_ph: 'Rechercher des pools de tournois existantes…',
    cmpool_new_btn: '＋ Nouveau / rejoindre un tournoi',
    cmpool_create_name_ph: 'Nom du tournoi (choisis dans la liste ou saisis-le)',
    cmpool_create_go: 'Créer',
    cmpool_create_cancel: 'Annuler',
    ...
    cmpool_custom_round_ph: 'round personnalisé…',
    cmpool_add_bracket: 'Ajouter un mod :',
    cmpool_custom_bracket_ph: 'mod personnalisé…',
    cmpool_add_map_ph: 'Colle un lien de difficulté de beatmap ou un id',
    cmpool_bulk_hint: 'Coller plusieurs liens ou ID de beatmaps à la fois',
    cmpool_bulk_ph: 'Colle des liens de difficulté ou des ID de beatmaps, un par ligne. Les préfixes comme « NM1: » sont acceptés.',
    cmpool_bulk_add: 'Tout ajouter',
    cmpool_bulk_working: 'Traitement…',
    cmpool_bulk_added: '{n} ajoutés',
    cmpool_bulk_dupes: '{n} déjà présents',
    cmpool_bulk_unresolved: '{n} non reconnus',
    cmpool_bulk_overflow: '{n} au-dessus de la limite',
    cmpool_remove_map: 'Retirer cette map',
    cmpool_remove_bracket: 'Retirer ce bracket de mod',
    cmpool_remove_round: 'Retirer ce round',
    mappools_hint: 'Les mappools officiels de chaque osu! World Cup (OWC / TWC / MWC 4K et 7K / CWC), tirés du wiki osu!. Choisissez une édition, puis transformez tout un tournoi — ou un seul round — en catégorie de collection en un clic.',
    mappools_add_event_btn: '➕ Ajouter tout le tournoi',
    mappools_round_add_btn: '➕ Ce round',
    mappools_add_confirm: 'Ajouter les {n} ensembles de beatmaps de « {name} » à votre collection et créer une catégorie du même nom ?',
    mappools_add_done: '« {name} » ajouté à votre collection : {n} nouveaux ensembles, {cat} catégories',
    mappools_mappack: 'Mappack',
    mappools_showcase: 'Showcase',
    mappools_empty: 'Aucun mappool à afficher pour cette édition',
    mappools_load_fail: 'Échec du chargement du mappool, réessayez plus tard',
    mappools_coverage: '{e} éditions de World Cup indexées · {n} maps · mis à jour le {t}',
    mappools_stats: '{r} rounds · {n} maps',
    mappools_copy_id: 'Copier l’ID',
    mappools_preview: 'Aperçu',
    ...
    collection_compare_btn_title: 'Importe une ancienne sauvegarde JSON pour voir ce qui a changé', collection_compare_title: 'Comparer la collection',
    collection_compare_hint: 'Importe une ancienne sauvegarde du bouton « Télécharger la collection en JSON » pour voir ce qui a été ajouté ou retiré par rapport à ta collection actuelle — ceci ne fait que comparer, ça ne touche jamais ta collection actuelle.',
    collection_compare_no_diff: 'Les deux collections sont identiques — aucune différence',
    ...
    resource_osudaily_desc: 'Conversion rang ↔ pp et historique de rang sur le long terme, tous modes',
    resource_osekai_desc: 'Solutions de médailles et classements alternatifs (badges, maps ranked, etc.)',
    resource_osustats_desc: 'Compte tes placements dans les classements — combien de top-50 / top-100',
    ...
    grade_history_tab: 'Historique des grades', grade_history_need_lookup: "Recherchez d'abord un joueur sur la page « Recherche PP »",
    grade_history_loading: "Chargement de l'historique des grades...", grade_history_load_fail: "Échec du chargement de l'historique des grades, réessayez plus tard",
    grade_history_note: "Les données proviennent du service tiers osu!Track — seuls les scores qu'il a effectivement enregistrés peuvent être affichés, sans garantie d'exhaustivité (l'API officielle d'osu! ne fournit pas d'historique complet des scores).",
    grade_history_empty: "osu!Track n'a aucun enregistrement pour ce joueur dans ce mode",
    ...
    howto_manual_body: `
        <div class="howto-group" id="howto-global">
            ...
            <div class="howto-feat"><b>Couleur du thème</b><span>Icône palette en haut à droite. Choisis une des 12 couleurs prédéfinies ou la tienne : l’accent de tout le site suit ; « Réinitialiser » revient au rose d’origine. Le choix est mémorisé dans ce navigateur.</span></div>
        ...
        <div class="howto-group" id="howto-core">
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>Outils et réglages (7 boutons)</b><span>Actualiser toutes les données des cartes → 📊 Tableau de bord statistiques (avec 8 badges de succès) → ✨ Assistant de collection (voir ci-dessous) → Marquer comme joué / import en un clic des favoris et plus joués (connexion requise) → 📁 Envoyer ton osu!.db pour voir quelles maps tu as déjà (osu! stable uniquement) → 🔒 Définir un mot de passe, requis pour les futures modifications/publications.</span></div>
                ...
                <div class="howto-feat"><b>Télécharger toute cette liste</b><span>Télécharge chaque map de l'onglet/recherche/filtre actuel (toutes les pages, pas seulement celle affichée) en .osz, une par une, via un miroir sans connexion — aucune app à installer. Le même bouton met en pause/reprend sans interrompre le fichier en cours. Une fois terminé, sélectionne-les tous dans ton explorateur de fichiers et glisse-les dans osu! pour les importer.</span></div>
                <div class="howto-feat"><b>Télécharger les sets que tu n’as pas</b><span>Apparaît une fois ton osu!.db choisi et indique combien de sets de la liste actuelle ton osu! n’a pas. Ne télécharge que ceux-là et ignore les autres, avec la même pause/reprise. Après les avoir importés dans osu!, choisis à nouveau ton osu!.db pour mettre le nombre à jour.</span></div>
