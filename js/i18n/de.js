I18N.de = {
    ...
    nav_dan: 'Dan-Kurse',
    dan_page_title: '✦ Dan-Kurse ✦',
    dan_hint: 'Dan-Kurse (Skill-Zertifizierung) fuer jeden Modus - von der Community erstellte Benchmark-Marathons, eine Map pro Dan. Angefuehrt vom aktuellen Projekt jedes Keymodes; weitere per Suche gefundene Dan-Kurse stehen unter "Mehr". Mania nur 4K/7K. Karte anklicken zum Oeffnen auf osu!, + zum Hinzufuegen zur Sammlung.',
    dan_load_fail: 'Dan-Kurse konnten nicht geladen werden', dan_empty: 'Keine Dan-Kurse fuer diesen Modus gefunden', dan_load_more: 'Mehr laden',
    dan_pinned: 'Kuratiert',
    dan_add_group_btn: 'Ganze Gruppe "{name}" zur Sammlung hinzufuegen', dan_add_group_confirm: 'Aus den {n} Sets in "{name}" eine Sammlungskategorie erstellen?',
    dan_collection_name: 'Dan-Kurse - {mode}',
    dan_more_summary: 'Weitere Dan-Kurse (aus der Suche, {n})', dan_more_note: 'Weitere Packs aus osu!s Beatmap-Suche, deren Titel/Kuenstler nach einem Dan-Kurs aussehen - nicht handgeprueft.',
    dan_standard_label: 'Bestehensgrenze', dan_resources_label: 'Ressourcen',
    dan_std_mania: 'Den ganzen Marathon in einem Durchgang mit 96%+ Genauigkeit clearen (95% bei manchen Einstiegs-Dans); Pausieren = Fehlversuch, nur Mirror/HD/FI/FL/HR/DT/NC erlaubt.',
    dan_std_osu: 'Den ganzen Durchgang in einem Sitzen mit 96%+ Genauigkeit clearen (Tapping-Dan-Course-Regel); Pausieren = Fehlversuch.',
    dan_std_taiko: 'Bewertet ueber Taikos Soul-Gauge - sie muss am Ende die Bestehensgrenze des Dans erreichen (je nach Dan). Grob eine hohe Genauigkeit ohne Unterbrechung.',
    dan_std_catch: 'Den ganzen Marathon clearen, ohne dass die Anzeige leerlaeuft; manche Dans haben eine zusaetzliche Genauigkeitsschwelle - siehe Forum-Thread.',
