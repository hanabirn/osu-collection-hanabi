I18N.de = {
    ...
    dan_hint: 'Dan-Kurse (Skill-Zertifizierung) für jeden Modus — von der Community erstellte Benchmark-Marathons, eine Map pro Dan. Die Liste basiert auf osu!s Beatmap-Suche plus einigen handverlesenen Anheftungen; mania nur 4K/7K. Karte anklicken zum Öffnen auf osu!, oder + zum Hinzufügen zur Sammlung.',
    dan_load_fail: 'Dan-Kurse konnten nicht geladen werden', dan_empty: 'Keine Dan-Kurse für diesen Modus gefunden', dan_load_more: 'Mehr laden',
    dan_pinned: 'Ausgewählt',
    dan_add_page_btn: 'Diese Seite zur Sammlung hinzufügen', dan_add_page_confirm: 'Aus den {n} Maps auf dieser Seite von „{name}“ eine Sammlungskategorie erstellen?',
