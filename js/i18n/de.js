I18N.de = {
    ...
    replay_submitting: 'Wird hochgeladen...', replay_rendering: 'Gesendet, Rendering gestartet...', replay_submit_fail: 'Senden fehlgeschlagen: {n}', replay_render_fail: 'Rendern fehlgeschlagen (Fehler {n})', replay_render_fail_short: 'Rendern fehlgeschlagen', replay_render_done: 'Video fertig!', replay_progress: 'Rendern: {n}', replay_skin_none: 'Keine passenden Skins gefunden', replay_history_empty: 'Noch keine Videos erstellt', replay_preview_show: 'Vorschau', replay_preview_hide: 'Vorschau ausblenden', replay_watch: 'Video ansehen', replay_history_pending: 'Wird gerendert...', replay_preview_expired: 'Dieses Video ist abgelaufen (o!rdr speichert Videos nur eine Zeit lang) – lade das Replay erneut hoch, um ein neues Video zu erstellen.',
