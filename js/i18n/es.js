I18N.es = {
    ...
    mplist_copy_btn: 'Copiar como lista !mp', mplist_copy_hint: 'Copiar una lista !mp lista para pegar en un lobby multi (tú eres el anfitrión)', mplist_copied: '{n} mapas copiados — pega una línea !mp map por ronda', mplist_copy_empty: 'Esta lista está vacía',
    ...
    howto_manual_body: `
        ...
        <div class="howto-group" id="howto-core">
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>Copiar como lista !mp</b><span>Convierte la lista actual en líneas <code>!mp map</code> listas para pegar en un lobby multijugador de osu! — sé el anfitrión y pega una por ronda. El comando <code>/mplist</code> del bot de Discord te envía la misma lista por MD.</span></div>
