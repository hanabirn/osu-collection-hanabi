I18N.es = {
    ...
    replay_submitting: 'Subiendo...', replay_rendering: 'Enviado, renderizado iniciado...', replay_submit_fail: 'Error al enviar: {n}', replay_render_fail: 'Error de renderizado (código {n})', replay_render_fail_short: 'Error de renderizado', replay_render_done: '¡Vídeo listo!', replay_progress: 'Renderizando: {n}', replay_skin_none: 'No se encontraron skins', replay_history_empty: 'Aún no hay vídeos generados', replay_preview_show: 'Vista previa', replay_preview_hide: 'Ocultar vista previa', replay_watch: 'Ver vídeo', replay_history_pending: 'Renderizando...', replay_preview_expired: 'Este vídeo ha caducado (o!rdr solo conserva los vídeos un tiempo limitado); vuelve a subir el replay para generar uno nuevo.',
