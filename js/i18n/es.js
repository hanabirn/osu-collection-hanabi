I18N.es = {
    ...
    nav_chat: 'Sala de chat',
    nav_dm: 'Mensajes directos',
    chat_page_title: 'Sala de chat',
    chat_page_hint: 'Chatea con otros jugadores, busca compañeros, comparte mapas — pega un enlace de un beatmap de osu! y se convierte en una tarjeta con un botón para añadirlo a tu colección con un clic.',
    chat_empty: 'Todavía nadie ha dicho nada — ¡sé el primero!', chat_load_fail: 'No se pudo cargar el chat, inténtalo más tarde',
    chat_input_placeholder: 'Escribe un mensaje...', chat_send_btn: 'Enviar',
    chat_emoji_btn_title: 'Emoji', chat_emoji_recent: 'Recientes',
    chat_edit_btn_title: 'Editar', chat_edited_marker: '(editado)',
    chat_edit_save: 'Guardar', chat_edit_cancel: 'Cancelar', chat_edit_fail: 'Error al editar, inténtalo de nuevo',
    chat_attach_btn_title: 'Adjuntar imagen / GIF', chat_media_remove_title: 'Quitar imagen',
    chat_media_too_big: 'La imagen es demasiado grande (máx. 4 MB)', chat_media_bad_type: 'Solo imágenes PNG, JPEG, GIF o WebP',
    chat_media_upload_fail: 'Error al subir la imagen, inténtalo de nuevo', chat_media_disabled: 'La subida de imágenes está desactivada',
    ...
    chat_translate_btn_title: 'Traducir este mensaje', chat_translate_hide_title: 'Ocultar traducción',
    chat_translate_loading: 'Traduciendo...', chat_translate_fail: 'Error al traducir, inténtalo más tarde', chat_translate_same_lang: 'Este mensaje ya está en tu idioma', chat_translate_unchanged: 'La traducción es igual al original',
    ...
    chat_rate_limited: 'Estás enviando demasiado rápido, más despacio', chat_send_fail: 'Error al enviar, inténtalo más tarde',

    dm_page_title: 'Mensajes directos', dm_page_hint: 'Chatea en privado con otros jugadores.',
    dm_new_username_placeholder: 'Introduce un nombre de usuario para iniciar una conversación...', dm_start_btn: 'Iniciar conversación',
    dm_login_required: 'Inicia sesión con osu! para usar los mensajes directos',
    dm_empty: 'Todavía no hay conversaciones — ¡introduce un nombre de usuario para enviar tu primer mensaje!',
    dm_thread_empty: 'Todavía no hay mensajes — ¡saluda!',
    dm_back_btn: 'Volver',
    ...
    skins_backup_btn: 'Guardar en la nube', skins_backup_title: 'Copia de seguridad en la nube',
    ...
    osu_category_delete_confirm: '¿Eliminar esta categoría? (Los beatmaps permanecen en tu colección — solo se quita la etiqueta.)', osu_deleted: '«{n}» quitado', osu_undo: 'Deshacer',
    ...
    osu_page_title: 'Colección de beatmaps osu! + PP total', lookup_mode_single: 'Consulta individual', lookup_mode_compare: 'Comparar dos', visitor_lookup_title: 'Consultar tu osu! PP', visitor_lookup_placeholder: 'Nombre de usuario o ID', visitor_lookup_btn: 'Buscar', osu_login_btn: 'Iniciar sesión con osu!', osu_logout_btn: 'Cerrar sesión', osu_login_fail: 'Error al iniciar sesión con osu!, inténtalo de nuevo',
    ...
    ctools_btn_title: 'Generar categorías desde tu cuenta, más una revisión', ctools_title: 'Herramientas de colección',
    ...
    ctools_health_dupes: 'Sets duplicados: {n}', ctools_health_dead: 'Eliminados de osu!: {n}', ctools_health_diffchanged: 'Nº de dificultades cambió: {n}', ctools_health_nonranked: 'No ranked (graveyard/pending/etc.): {n}', ctools_health_failed: 'No se pudo comprobar (fallo de conexión, vuelve a escanear más tarde): {n}',
    ...
    osu_plays_empty_recent: 'Sin partidas en las últimas 24 horas', osu_plays_empty_best: 'Sin datos de mejores partidas',
    ...
    catalog_mode_all: 'Todos los modos',
    catalog_status_all: 'Todos los estados', catalog_status_ranked: 'Ranked', catalog_status_loved: 'Loved', catalog_nsfw_toggle: 'Incluir 18+',
    catalog_coverage: '{n} beatmapsets indexados · actualizado {t} · {m} coinciden con el filtro actual (la base sigue creciendo, aún no todos los mapas ranked)',
    ...
    games_back: 'Volver',
    games_daily_prompt: 'Quedan {n} intentos',
    games_quiz_title: 'Género rápido',
    games_quiz_blurb: 'Aparece un mapa, toca su género. 60 segundos, acierta todos los que puedas.',
    games_quiz_prompt: '¿Qué género es este?',
    games_quiz_time: '{n}s',
    games_quiz_score: '{n} aciertos',
    games_quiz_over: '¡Tiempo! {n} aciertos.',
    games_quiz_best: 'Mejor {n}',
    games_quiz_again: 'Jugar otra vez',
    games_quiz_correct_was: 'Era {name}',
    games_quiz_no_data: 'Aún no hay suficientes datos de mapas, inténtalo más tarde.',
    ...
    games_daily_blurb: 'Un set ranked al día — adivínalo por una portada borrosa, con una pista por cada fallo.',
    games_hilo_title: 'Higher or Lower',
    games_hilo_blurb: 'Dos mapas de Farm — elige cuál tiene el valor más alto. Sin fin, por rachas.',
    games_daily_not_ready: 'El puzzle de hoy aún no está listo, inténtalo en un minuto.',
    games_daily_input_ph: 'Título de la canción o del mapa…',
    games_daily_guess_btn: 'Adivinar',
    games_daily_win: '¡Acertado en {n}!',
    games_daily_lose: 'Sin intentos.',
    games_daily_share: 'Copiar resultado',
    games_daily_copied: 'Resultado copiado al portapapeles',
    games_daily_streak: 'racha de {n} días',
    games_daily_clip: 'Reproducir {s}s',
    games_hint_genre: 'Género',
    games_hint_lang: 'Idioma',
    games_hint_year: 'Ranked',
    games_hint_sr: 'Dificultad (★)',
    games_hint_mapper: 'Mapper',
    games_hilo_ask: '¿{stat} más alto?',
    games_hilo_higher: 'Más alto',
    games_hilo_lower: 'Más bajo',
    games_hilo_next: 'Siguiente',
    games_hilo_again: 'Jugar otra vez',
    games_hilo_over: 'Racha terminada en {n}.',
    games_hilo_best: 'Mejor {n}',
    games_hilo_streak: 'Racha {n}',
    games_hilo_no_data: 'Aún no hay suficientes datos de mapas, inténtalo más tarde.',
    games_stat_sr: 'dificultad',
    games_stat_bpm: 'BPM',
    games_stat_len: 'duración',
    games_stat_pp: 'PP de farm',
    games_stat_plays: 'número de jugadas',
    games_save_btn: 'Añadir a la colección',
    games_save_confirm: '¿Añadir este beatmapset a tu colección?',
    games_board_title: 'Clasificación',
    games_board_empty: 'Aún no hay puntuaciones, ¡sé el primero!',
    games_board_login: 'Inicia sesión y tus puntuaciones entrarán en la clasificación',
    games_save_category: 'De minijuegos',
    games_save_done: 'Se añadieron {n} set(s) a tu colección',
    mappools_page_title: 'Mappools de la World Cup',
    ...
    cmpool_import_none: 'wyBin no tiene datos de pool para este torneo — rellénalo a mano',
    cmpool_search_ph: 'Buscar pools de torneos existentes…',
    cmpool_new_btn: '＋ Nuevo / unirse a un torneo',
    cmpool_create_name_ph: 'Nombre del torneo (elige de la lista o escríbelo)',
    cmpool_create_go: 'Crear',
    cmpool_create_cancel: 'Cancelar',
    ...
    cmpool_custom_round_ph: 'ronda personalizada…',
    cmpool_add_bracket: 'Añadir mod:',
    cmpool_custom_bracket_ph: 'mod personalizado…',
    cmpool_add_map_ph: 'Pega un enlace de dificultad de beatmap o un id',
    cmpool_bulk_hint: 'Pega varios enlaces o IDs de beatmaps a la vez',
    cmpool_bulk_ph: 'Pega enlaces de dificultad o IDs de beatmaps, uno por línea. Se admiten prefijos como «NM1:».',
    cmpool_bulk_add: 'Añadir todo',
    cmpool_bulk_working: 'Procesando…',
    cmpool_bulk_added: '{n} añadidos',
    cmpool_bulk_dupes: '{n} ya estaban',
    cmpool_bulk_unresolved: '{n} no reconocidos',
    cmpool_bulk_overflow: '{n} sobre el límite',
    cmpool_remove_map: 'Quitar este mapa',
    cmpool_remove_bracket: 'Quitar este bracket de mod',
    cmpool_remove_round: 'Quitar esta ronda',
    mappools_hint: 'Los mappools oficiales de cada osu! World Cup (OWC / TWC / MWC 4K y 7K / CWC), tomados del wiki de osu!. Elige una edición y convierte todo un torneo —o una sola ronda— en una categoría de colección con un clic.',
    mappools_add_event_btn: '➕ Añadir torneo completo',
    mappools_round_add_btn: '➕ Esta ronda',
    mappools_add_confirm: '¿Añadir los {n} conjuntos de beatmaps de «{name}» a tu colección y crear una categoría con ese nombre?',
    mappools_add_done: '«{name}» añadido a tu colección: {n} conjuntos nuevos, {cat} categorías',
    ...
    collection_compare_btn_title: 'Sube una copia JSON antigua para ver qué cambió', collection_compare_title: 'Comparar colección',
    collection_compare_hint: 'Sube una copia antigua del botón "Descargar colección como JSON" para ver qué se añadió o eliminó respecto a tu colección actual — esto solo compara, nunca modifica tu colección actual.',
    collection_compare_no_diff: 'Ambas colecciones son idénticas — sin diferencias',
    ...
    resource_osupps_desc: 'Otro rastreador de farm maps, útil para comparar',
    ...
    resource_osustats_desc: 'Cuenta tus posiciones en las tablas: cuántos top-50 / top-100 tienes',
    ...
    grade_history_tab: 'Historial de rangos', grade_history_need_lookup: 'Primero busca a un jugador en la página "Búsqueda de PP"',
    grade_history_loading: 'Cargando historial de rangos...', grade_history_load_fail: 'Error al cargar el historial de rangos, inténtalo más tarde',
    grade_history_note: 'Los datos provienen del servicio externo osu!Track: solo puede mostrar las puntuaciones que realmente registró, sin garantía de estar completo (la API oficial de osu! no ofrece un historial completo de puntuaciones).',
    grade_history_empty: 'osu!Track no tiene registros de este jugador en este modo',
    ...
    howto_page_title: 'Guía de uso', howto_page_hint: 'Agrupada igual que el menú del sitio — qué hace cada página y botón, y cómo usarlo.',
    howto_group_global: 'General del sitio',
    howto_manual_body: `
        <div class="howto-group" id="howto-global">
            ...
            <div class="howto-feat"><b>Volumen</b><span>Altavoz abajo a la derecha — controla el volumen de vista previa de las tarjetas de colección.</span></div>
            <div class="howto-feat"><b>Recargar</b><span>Abajo a la derecha — recarga toda la página.</span></div>
            <div class="howto-feat"><b>Me gusta / Guía de uso / Compartir</b><span>Tres botones justo debajo del título del sitio: "Me gusta" suma al contador; "Guía de uso" es esta página; "Compartir" copia un enlace para enviar a amigos.</span></div>
        </div>

        <div class="howto-group" id="howto-core">
            <h3 class="howto-group-title">Funciones principales</h3>

            <div class="howto-tab">
                <div class="howto-tab-title">Colección <small>página de inicio predeterminada</small></div>
                <p class="howto-tab-desc">Organiza tu propia biblioteca osu!: añade, categoriza, exporta de vuelta al juego, o compara con un backup antiguo.</p>
                <div class="howto-feat"><b>Añadir un beatmap</b><span>Pega el ID o la URL osu! del mapa (beatmapsets/... o /b/... funcionan) y pulsa Añadir.</span></div>
                <div class="howto-feat"><b>Importar/exportar (6 botones)</b><span>De izquierda a derecha: Exportar backup JSON → Importar JSON para restaurar → Copiar enlace para compartir → Descargar tarjeta de vista previa PNG → Exportar como collection.db para usar directo en osu! → ⚔ Comparar, sube un backup antiguo para ver qué se añadió/eliminó.</span></div>
                <div class="howto-feat"><b>Herramientas y ajustes (7 botones)</b><span>Actualizar datos de todos los mapas → 📊 Panel de estadísticas (con 8 insignias de logros) → ✨ Asistente de colección (ver abajo) → Marcar como jugado / importar favoritos y más jugados con un clic (requiere sesión) → 📁 Subir tu osu!.db para ver qué mapas ya tienes (solo osu! stable) → 🔒 Establecer contraseña, necesaria para editar/publicar después.</span></div>
                <div class="howto-feat"><b>Buscar / filtrar / ordenar</b><span>Busca por título o artista; filtra por idioma, género, fuente o artista; ordena por calificación de estrellas.</span></div>
                <div class="howto-feat"><b>Descargar todos los archivos de esta lista</b><span>Descarga cada mapa de la pestaña/búsqueda/filtro actual (todas las páginas, no solo la visible) como .osz, uno por uno, vía un mirror sin inicio de sesión — sin instalar ninguna app. El mismo botón pausa/reanuda sin cortar el archivo en curso. Al terminar, selecciónalos todos en tu explorador de archivos y arrástralos juntos a osu! para importarlos.</span></div>
                <div class="howto-feat"><b>Descargar los sets que aún no tienes</b><span>Aparece después de elegir tu osu!.db y muestra cuántos sets de la lista actual no tiene tu osu!. Descarga solo esos y omite el resto, con la misma pausa/reanudación. Tras importarlos en osu!, vuelve a elegir tu osu!.db para actualizar el número.</span></div>
                <div class="howto-feat"><b>Copiar !mp map</b><span>Cada tarjeta tiene un botón ⚔ que copia ese mapa como línea <code>!mp map</code> — sé el anfitrión en un lobby multi de osu! y pégalo para poner el mapa. El comando <code>/map</code> del bot de Discord muestra la misma línea.</span></div>
                <div class="howto-feat"><b>Pestañas de categoría</b><span>Además de las pestañas fijas Favoritos/Todas las canciones/Standard/Taiko/Catch/Mania, el icono de engranaje abre "Gestionar categorías" para añadir las tuyas.</span></div>
                <div class="howto-feat"><b>Explorar más</b><span>7 tarjetas de acceso directo abajo, que saltan a otras pestañas comunes.</span></div>
                <div class="howto-feat"><b>✨ Asistente de colección</b><span>En realidad son tres herramientas: ① generar categorías desde tu cuenta (favoritos/más jugados/mejores/recientes/un mapper específico) ② revisión de salud (encuentra duplicados, eliminados, no-ranked, o mapas con cambio en el número de dificultades). Las tres solo añaden, nunca sobrescriben tu colección existente.</span></div>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Galería Pública</div>
            ...
            <div class="howto-tab">
                <div class="howto-tab-title">Galería de Skins</div>
                <p class="howto-tab-desc">Comparte capturas reales de skins en el juego para que otros vean cómo se ve realmente antes de elegirlo.</p>
                <div class="howto-feat"><b>Compartir mi captura de skin</b><span>Rellena nombre y autor (opcional), da un enlace de descarga o archivo .osk (al menos uno), elige el modo, sube una captura y publica.</span></div>
                <div class="howto-feat"><b>Explorar / filtrar</b><span>Busca por nombre o autor, filtra por modo, ordena por reciente o más populares, o muestra solo las que te gustaron o subiste.</span></div>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Sala de Chat</div>
                <p class="howto-tab-desc">Un chat público compartido por todos los visitantes.</p>
                <div class="howto-feat"><b>Publicar</b><span>Requiere sesión. Pega un enlace de beatmap osu! y se convierte automáticamente en una tarjeta con un botón de "añadir a colección" de un clic.</span></div>
                <div class="howto-feat"><b>Acciones por mensaje</b><span>Haz clic en el avatar/nombre para abrir el perfil osu! de ese jugador, ver su bandera de país, toca 🌐 para traducir a tu idioma de interfaz actual, responde a un mensaje, o bórralo (tus propios mensajes, o cualquiera si eres el propietario del sitio).</span></div>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Mensajes Directos</div>
                <p class="howto-tab-desc">Una conversación privada 1 a 1 con un jugador, invisible para los demás.</p>
                <div class="howto-feat"><b>Iniciar una conversación</b><span>Requiere sesión. Escribe su nombre de usuario osu! y pulsa "Iniciar conversación".</span></div>
                <div class="howto-feat"><b>Lista de conversaciones / sin leer</b><span>Los conteos sin leer también aparecen como insignia junto a "Mensajes" en el menú ☰. Abrir una conversación muestra el hilo; "Volver" regresa a la lista.</span></div>
            </div>
        </div>

        <div class="howto-group" id="howto-tools">
            <h3 class="howto-group-title">Caja de Herramientas</h3>
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>Ranked / Loved</b><span>El icono en la esquina inferior derecha de cada portada indica el estado: chevrones azules para ranked, un corazón rosa para loved. El menú de estado de arriba filtra por uno de ellos.</span></div>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Mappools del Mundial</div>
                <p class="howto-tab-desc">Mappools oficiales de cada OWC/TWC/MWC (4K・7K)/CWC.</p>
                <div class="howto-feat"><b>Elegir edición / ronda</b><span>Pestaña de modo → lista de ediciones → elige una para navegar por ronda, cada mapa con su mod indicado.</span></div>
                <div class="howto-feat"><b>➕ Añadir a colección</b><span>Añade toda la edición, o solo una ronda — no hace falta tomar todo.</span></div>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Mappools de la comunidad</div>
                <p class="howto-tab-desc">Pools de torneo armados por jugadores, separados de los oficiales de la Copa del Mundo.</p>
                <div class="howto-feat"><b>Crear / unirse a un torneo</b><span>Requiere iniciar sesión. Crea uno propio o añade pools a un torneo que ya existe.</span></div>
                <div class="howto-feat"><b>Rondas y pools</b><span>Separados por ronda — Qualifiers, Group stage, Round of 16, etc. Cada mapa se puede escuchar, copiar por ID o descargar.</span></div>
                <div class="howto-feat"><b>Recogida automática</b><span>Los torneos públicos que ya llenaron su pool en wyBin se importan periódicamente. Nunca se sobrescribe lo que creaste a mano.</span></div>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Búsqueda de PP</div>
        ...
        <div class="howto-group" id="howto-resources">
            <h3 class="howto-group-title">Recursos</h3>

            <div class="howto-tab">
                <div class="howto-tab-title">Mis Skins <small>una pestaña distinta a "Galería de Skins"</small></div>
                <p class="howto-tab-desc">Tu almacenamiento privado de skins, no se muestra públicamente — usa "Galería de Skins" para eso.</p>
                <div class="howto-feat"><b>Subir / descargar</b><span>Los archivos .osk subidos viven solo en este navegador — cambiar de dispositivo o borrar datos del navegador los pierde; descarga en cualquier momento para recuperarlos.</span></div>
                <div class="howto-feat"><b>☁️ Respaldo en la nube</b><span>Solo aparece con sesión iniciada. Hasta 30 archivos, 4MB cada uno; "Restaurar localmente" los añade de vuelta a la lista de arriba.</span></div>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Noticias</div>
                <p class="howto-tab-desc">Una lista de publicaciones oficiales del registro de cambios de osu! — solo para explorar, sin acciones necesarias.</p>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Torneos</div>
                <p class="howto-tab-desc">Combina la sección Tournaments del foro oficial con los listados comunitarios de wyBin (eventos no oficiales — confirma las reglas del organizador antes de inscribirte).</p>
                <div class="howto-feat"><b>Filtro de modo</b><span>El modo se detecta automáticamente por palabras clave del título; las publicaciones no reconocidas solo aparecen en "Todos".</span></div>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Recursos</div>
                <p class="howto-tab-desc">Una lista de herramientas comunitarias recomendadas que no hacía falta rehacer aquí — solo para explorar.</p>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Sugerencias y Mejoras</div>
                <p class="howto-tab-desc">Un formulario de comentarios. Escribe tus ideas y envía — solo el propietario del sitio lo ve, otros visitantes nunca.</p>
            </div>

            <div class="howto-tab">
                <div class="howto-tab-title">Editor BBCode</div>
                <p class="howto-tab-desc">Para escribir un perfil de osu! o un post del foro: escribe a la izquierda y lo ves renderizado a la derecha.</p>
                <div class="howto-feat"><b>Barra de herramientas</b><span>Botones para negrita, cursiva, subrayado, tachado, color, tamaño, enlaces, imágenes, centrado, listas, citas, código y cajas spoiler.</span></div>
                <div class="howto-feat"><b>Copiar BBCode</b><span>Un clic copia todo el código, listo para pegar en osu!.</span></div>
            </div>
        </div>
    `,
};
