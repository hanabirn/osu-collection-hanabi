I18N.es = {
    ...
    nav_dan: 'Cursos dan',
    dan_page_title: '✦ Cursos dan ✦',
    dan_hint: 'Cursos dan (certificacion de habilidad) para cada modo - maratones de referencia hechos por la comunidad, un mapa por dan. Encabezados por el proyecto actual de cada keymode; otros cursos dan encontrados por busqueda estan en "Mas". Mania solo 4K/7K. Haz clic en una tarjeta para abrirla en osu!, + para anadirla a tu coleccion.',
    dan_load_fail: 'Error al cargar los cursos dan', dan_empty: 'No se encontraron cursos dan para este modo', dan_load_more: 'Cargar mas',
    dan_pinned: 'Elegido',
    dan_add_group_btn: 'Anadir todo "{name}" a la coleccion', dan_add_group_confirm: 'Crear una categoria de coleccion con los {n} sets de "{name}"?',
    dan_collection_name: 'Cursos dan - {mode}',
    dan_more_summary: 'Mas cursos dan (por busqueda, {n})', dan_more_note: 'Otros packs de la busqueda de mapas de osu! cuyo titulo/artista parece un curso dan - sin revision manual.',
    dan_standard_label: 'Criterio de aprobado', dan_resources_label: 'Recursos',
    dan_std_mania: 'Completa todo el maraton de una sola vez con 96%+ de precision (95% en algunos dan de introduccion); pausar hace fallar, solo Mirror/HD/FI/FL/HR/DT/NC permitidos.',
    dan_std_osu: 'Completa toda la serie de una sola vez con 96%+ de precision (regla de Tapping Dan Course); pausar hace fallar.',
    dan_std_taiko: 'Se juzga por el medidor de alma del taiko - debe alcanzar la linea de aprobado de ese dan al final (varia por dan). En general, alta precision sin interrupciones.',
    dan_std_catch: 'Completa todo el maraton sin que se vacie el medidor; algunos dan tienen un umbral de precision extra - consulta el hilo del foro.',
    ...
    howto_manual_body: `
        ...
        <div class="howto-group" id="howto-core">
            ...
            <div class="howto-tab">
                ...
                <div class="howto-feat"><b>Pestañas de categoría</b><span>Además de las pestañas fijas Favoritos/Standard/Taiko/Catch/Mania, el icono de engranaje abre "Gestionar categorías" para añadir las tuyas.</span></div>
