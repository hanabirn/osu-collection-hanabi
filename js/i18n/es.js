I18N.es = {
    ...
    dan_hint: 'Cursos dan (certificación de habilidad) para cada modo — maratones de referencia hechos por la comunidad, un mapa por dan. La lista se basa en la búsqueda de mapas de osu! más algunos fijados a mano; mania solo 4K/7K. Haz clic en una tarjeta para abrirla en osu!, o + para añadirla a tu colección.',
    dan_load_fail: 'Error al cargar los cursos dan', dan_empty: 'No se encontraron cursos dan para este modo', dan_load_more: 'Cargar más',
    dan_pinned: 'Elegido',
    dan_add_page_btn: 'Añadir esta página a la colección', dan_add_page_confirm: '¿Crear una categoría de colección con los {n} mapas de esta página de «{name}»?',
