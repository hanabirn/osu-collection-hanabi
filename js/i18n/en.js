I18N.en = {
    ...
    dan_hint: "Skill-certification dan courses for each mode — community-made benchmark marathons, one map per dan. The list is driven by osu!'s beatmap search plus a few hand-picked pins; mania is 4K/7K only. Click a card to open it on osu!, or + to add it to your collection.",
    dan_load_fail: 'Failed to load dan courses', dan_empty: 'No dan courses found for this mode', dan_load_more: 'Load more',
    dan_pinned: 'Picked',
    dan_add_page_btn: 'Add this page to collection', dan_add_page_confirm: 'Create a collection category from the {n} maps on this page of "{name}"?',
