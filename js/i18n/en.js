I18N.en = {
    ...
    tournaments_title: '✦ Tournaments ✦', tournaments_hint: "Community tournament posts from the official \"Tournaments\" subforum — these aren't official events, so check each organizer's rules before signing up.", tournaments_filter_hint: 'Gamemode is guessed from the title — threads that don\'t match a mode only show under "All".', osu_filter_all: 'All',
