I18N.en = {
    ...
    replay_submitting: 'Uploading...', replay_rendering: 'Submitted, rendering started...', replay_submit_fail: 'Submit failed: {n}', replay_render_fail: 'Render failed (error {n})', replay_render_fail_short: 'Render failed', replay_render_done: 'Video ready!', replay_progress: 'Rendering: {n}', replay_skin_none: 'No matching skins found', replay_history_empty: 'No videos rendered yet', replay_preview_show: 'Preview', replay_preview_hide: 'Hide preview', replay_watch: 'Watch Video', replay_history_pending: 'Rendering...', replay_preview_expired: 'This video has expired (o!rdr only keeps videos for a while) — re-upload the replay to render a new one.',
