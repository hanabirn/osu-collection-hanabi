I18N.en = {
    ...
    osu_profile_import_btn_title: 'Import from osu! profile (favourites / most-played)',
    ...
    ctools_btn_title: 'Collection tools (generate from osu! / health check)', ctools_title: '✨ Collection Tools',
    ...
    practice_gen_lowacc: 'Accuracy grind', practice_gen_taste: 'More like your top plays',
    practice_cat_push: '🎯 Push for pp', practice_cat_goal: '🎯 Goal {target}pp',
    practice_cat_lowacc: '🎯 Accuracy grind', practice_cat_taste: '🎯 Like your top plays',
    ...
    collection_db_btn_title: 'Import / export osu! game collections', collection_db_title: '📦 Export to osu! Collection',
